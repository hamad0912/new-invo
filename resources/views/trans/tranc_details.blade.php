      ...
      <div class="bot">
          <div id="table">
              <table>
                  ...
                  <tr class="service">
                      <td class="tableitem"><p class="itemtext">{{ $details->product }}</p></td>
                  <td class="tableitem"><p class="itemtext">{{ $details->quantity_id}}</p></td>
                  <td class="tableitem"><p class="itemtext">{{ number_format($details->unitprice, 2)}}</p></td>
                  <td class="tableitem"> <p class="itemtext">{{ $details->discount ? ' ' : '0' }}</p> </td>
                  <td class="tableitem"> <p class="itemtext">{{ number_format($details->amount, 2)}}</p> </td>
                  </tr>
                  @endforeach
                  <tr class="tabletitle">
                      <td></td>
                      ...
                      <td class="PAyment"><p class="itemtext"> المجموع SAR{{ number_format($details->amount, 2)}}</p> </td>
                      <td></td>
                  </tr>
