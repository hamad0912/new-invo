...
} elseif ($_instance->childHasBeenRendered('eVgbke2')) {
    $componentId = $_instance->getRenderedChildComponentId('eVgbke2');
    $componentTag = $_instance->getRenderedChildComponentTagName('eVgbke2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('eVgbke2');
} else {
    $response = \Livewire\Livewire::mount('order');
    $html = $response->html();
    $_instance->logRenderedChild('eVgbke2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
