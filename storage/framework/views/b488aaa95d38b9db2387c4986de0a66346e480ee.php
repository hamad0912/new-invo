...
} elseif ($_instance->childHasBeenRendered('ljfRmuz')) {
    $componentId = $_instance->getRenderedChildComponentId('ljfRmuz');
    $componentTag = $_instance->getRenderedChildComponentTagName('ljfRmuz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ljfRmuz');
} else {
    $response = \Livewire\Livewire::mount('products');
    $html = $response->html();
    $_instance->logRenderedChild('ljfRmuz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/hamadotb/Sites/invo/resources/views/products/index.blade.php ENDPATH**/ ?>