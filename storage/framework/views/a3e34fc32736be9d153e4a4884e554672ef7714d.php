    ...
    <div class="row">
      ...
      <div class="card">
            ...
            <form action="<?php echo e(route('orders.store')); ?>" method="POST">
                ...
                value="<?php echo e($cart->product_qty *  $cart->product->price); ?>"
                               ...
                               <tr>
                                   ...
                                   <td>
                                    <label for="">جوال العميل</label>
                                     <input type="phone" name="customer_phone" id="" class="form-control">
                                   </td>
                               </tr>
                           </table>
                          </div>
...
<?php /**PATH /Users/hamadotb/Sites/invo/resources/views/livewire/order.blade.php ENDPATH**/ ?>