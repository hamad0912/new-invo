...
} elseif ($_instance->childHasBeenRendered('b2C9Lz4')) {
    $componentId = $_instance->getRenderedChildComponentId('b2C9Lz4');
    $componentTag = $_instance->getRenderedChildComponentTagName('b2C9Lz4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('b2C9Lz4');
} else {
    $response = \Livewire\Livewire::mount('order');
    $html = $response->html();
    $_instance->logRenderedChild('b2C9Lz4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/hamadotb/Sites/new-invo/resources/views/orders/index.blade.php ENDPATH**/ ?>